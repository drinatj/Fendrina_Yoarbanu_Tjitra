        ...
        <div>
            <div className="catalog">
                <div className="leftCatalog">
                    <img src={data.product.gallery[3]} alt="img" className="smallPicture"/>
                    <img src={data.product.gallery[1]} alt="img" className="smallPicture"/>
                    <img src={data.product.gallery[2]} alt="img" className="smallPicture"/>
                </div>
                <div className="centerCatalog">
                    <img src={data.product.gallery[3]} alt="img" className="bigPicture"/>
                </div>
